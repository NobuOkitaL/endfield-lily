...
const DialogFooter = ({
  ...
  <div
    className={cn(
      // Verge: always right-aligned footer buttons
      "flex flex-row justify-end gap-2 flex-wrap",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      // Verge: Hanken Grotesk 24px/700 white
      "font-sans text-2xl font-bold leading-none text-white",
      className
    )}
    {...props}
  />
